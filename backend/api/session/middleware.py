...
class SessionMiddleware:
    """
    Overrided Session Middleware from `starlette.middleware.sessions.SessionMiddleware`

    It contains session id generation logic that is produced in `storage.SessionStorage`.
    This ensures that the session will always contain session id
    """
    def __init__(
        self,
        app: ASGIApp,
